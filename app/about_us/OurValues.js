...
const OurValues = () => {
  return (
    <div className={styles["value-containers"]}>
      <div className={styles["value-container"]}>
        <img className={styles["value-icons"]} src="/icons/exploration.png"></img>
        <h2 className={styles["value-title"]}>Exploration</h2>
      ...
      <div className={styles["value-container"]}>
        <img className={styles["value-icons"]} src="/icons/innovation.png"></img>
      ...
      <div className={styles["value-container"]}>
        <img className={styles["value-icons"]} src="/icons/sustainability.png"></img>
        <h2 className={styles["value-title"]}>Sustainability</h2>
        <p className={styles["value-text"]}>
      ...
      <div className={styles["value-container"]}>
        <img className={styles["value-icons"]} src="/icons/community.png"></img>
        <h2 className={styles["value-title"]}>Community</h2>
        <p className={styles["value-text"]}>
